...
const RequestMoney = () => {
  ...
  const qrValue = `upi://pay?pa=${encodeURIComponent(form.fromEmail)}&am=${encodeURIComponent(form.amount)}&tn=${encodeURIComponent(form.message)}`;
